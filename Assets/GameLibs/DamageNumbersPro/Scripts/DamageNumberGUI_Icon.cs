...
namespace DamageNumbersPro
{
    ...
    public class DamageNumberGUI_Icon : DamageNumber
    {
        /* 
        ...
        {
            textMeshProA.fontMaterial = m;
            textMeshProB.fontMaterial = m;
        }
        
        
        public override void SetSize(int sizeText)
        {
            textMeshProA.fontSize = sizeText;
            textMeshProB.fontSize = sizeText;
        }
        ...
        public override void SetAnchoredPosition(Transform rectParent, Vector3 worldPosition)
        {
            //Old Transform:
            Vector3 oldScale = transform.localScale;
