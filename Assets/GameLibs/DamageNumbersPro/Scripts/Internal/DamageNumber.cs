...
namespace DamageNumbersPro
{
    public abstract class DamageNumber : MonoBehaviour
    {
        ...
        {
            textMeshRenderer.material = m;
            UpdateText();
        }

        public virtual void SetSize(int sizeText)
        {
            textMeshPro.fontSize = sizeText;
        }
        /// <summary>
        ...
        public virtual void SetAnchoredPosition(Transform rectParent, Vector3 worldPosition)
        {
            //Old Transform:
            Vector3 oldScale = transform.localScale;
            Vector3 oldRotation = transform.eulerAngles;
