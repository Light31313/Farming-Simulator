...
namespace FirstGearGames.SmoothCameraShaker
{
    public class ObjectShaker : MonoBehaviour
    {
        ...
        /// </summary>
        [Tooltip("True to limit how much magnitude can be applied to this CameraShaker.")] [SerializeField]
        private bool _limitMagnitude = false;

        /// <summary>
        /// How much positional magnitude to limit this CameraShaker to.
        /// </summary>
        [Tooltip("How much positional magnitude to limit this CameraShaker to.")] [SerializeField]
        private float _positionalMagnitudeLimit = 10f;

        /// <summary>
        /// How much rotational manitude to limit this CameraShaker to.
        /// </summary>
        [Tooltip("How much rotational manitude to limit this CameraShaker to.")] [SerializeField]
        private float _rotationalMagnitudeLimit = 3f;

        /// <summary>
        /// ShakeData to run when enabled. Leave empty to not use this feature.
        /// </summary>
        [Tooltip("ShakeData to run when enabled. Leave empty to not use this feature.")] [Space(10)] [SerializeField]
        ...
        internal void Disable()
        {
            ...
            if (Shaking)
            {
                ...
                OnShakeFixedUpdate?.Invoke(this,
                    new ShakeUpdate(new ShakeValues(), new ShakeValues(), new ShakeValues()));
                _fixedCanvases = null;
                _fixedRigidbodies = null;
            }
        ...
        public ShakerInstance Shake(ShakeData data)
        {
            ...
            if (data.TotalDuration == 0f && data.FadeInDuration == 0f && data.FadeOutDuration == 0f)
            {
                if (Debug.isDebugBuild)
                    Debug.LogWarning("No durations are specified in data; cannot generate a ShakerInstance.");
                return null;
            }
            ...
            {
                if (Debug.isDebugBuild)
                    Debug.LogWarning("No influences are specified in data; cannot generate a ShakerInstance.");
                return null;
            }
